                        ...
                        pem.readPkcs12(pfx, {
                            ...
                            addSignedXml(object, cert, particularitiesObject, numeroLote)
                                .then(signedXmlRes => {
                                    ...
                                    createSignature(xml, cert, 'GerarNfseEnvio', signatureId, isEmptyUri, isDifferentSignature)
                                        .then(xmlSignature => {
                                            // if (particularitiesObject['xsds']['enviarLoteRps']) {
                                            //     validator.validateXML(xmlSignature, __dirname + particularitiesObject['xsds']['enviarLoteRps'], function (err, validatorResult) {
                                            //         if (err) {
                                            ...
                                            try {
                                                ...
                                                if (particularitiesObject['soapActions'] && particularitiesObject['soapActions']['gerarNfseEnvio']) {
                                                    result['soapAction'] = particularitiesObject['soapActions']['gerarNfseEnvio'];
                                                }
